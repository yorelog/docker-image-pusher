...
impl ProgressTracker {
    ...
    pub fn update(&mut self, uploaded: u64) {
        ...
        if elapsed_since_last >= Duration::from_secs(5) 
            ...
            self.output.progress_with_metrics(uploaded, self.total_size, &self.operation_name);
    ...
    pub fn finish(&self) {
        self.output.progress_with_metrics(self.total_size, self.total_size, &self.operation_name);
